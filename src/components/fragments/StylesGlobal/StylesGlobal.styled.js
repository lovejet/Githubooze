...
const Fonts = createGlobalStyle`
  @font-face {
    ...
    src: local('Haptik--regular'), local('Haptik--regular'),
...
const Default = createGlobalStyle`
  :root {
    --content-padding-left: ${spaceMb(2)};
    --content-padding-right: ${spaceMb(2)};
    --content-padding-lg-left: ${spaceDt(11)};
    --content-padding-lg-right: ${spaceDt(14)};
